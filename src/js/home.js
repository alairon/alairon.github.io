        ...
        return (
            <div>
                <div id="content">
                    <h1>Welcome!</h1>
                    <p id="p-body">
                        Welcome to my website! Please pardon the current state this website is in. 
                        <br />
                        ...
                        <br />
                        <a href={'./legacy/index.html'}>Click here to see my abandoned legacy home page, not that it had much content back then either.</a>
                    </p>
                    <br />
                    <p id="p-body">
